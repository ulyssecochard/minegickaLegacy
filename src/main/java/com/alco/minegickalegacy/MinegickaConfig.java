...
@Mod.EventBusSubscriber(modid = MinegickaMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class MinegickaConfig {
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS = BUILDER
            ...
            .defineListAllowEmpty("items", List.of("minecraft:iron_ingot"), MinegickaConfig::validateItemName);
